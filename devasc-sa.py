...
if choice == "N" or choice == "n":
  ...
  accessToken = "Bearer " + accessToken
    ...
    accessToken = "Bearer ODcyNDdkNjMtY2E2ZC00YWQwLWE4OTgtN2M1NWNjZDM4YjRjYWM0N2I3NzgtZjIz_P0A1_cb0fa6b7-6c1c-45f5-aae5-b00413680b83"
...
# 8. Convert the timestamp epoch value to a human readable date and time.
        ...
        timeString = str(time.ctime(timestamp))   
...
# 11. Store the location received from the MapQuest API in a variable
        ...
        if(not CountryResult) or (CountryResult == "XZ"):
